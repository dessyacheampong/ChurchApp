        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="text-right flex flex-col items-end gap-2">
              ...
              <div className="text-blue-100 text-xs italic">Deut 4:20 "... to be His people, an inheritance as you are this day."</div>
              <div className="flex items-center gap-3">
                {isSaving && <span className="text-blue-200 text-xs animate-pulse">Saving...</span>}
                <span className="text-xs text-green-200 bg-green-700 bg-opacity-40 px-2 py-1 rounded-full">● Connected</span>
                <button onClick={handleDisconnect} className="text-xs text-blue-200 hover:text-white underline">Disconnect</button>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-200">
                <div className="flex items-center justify-between">
                  <div><p className="text-blue-100 text-sm font-medium">Total Members</p><p className="text-4xl font-bold mt-2">{members.length}</p></div>
              ...
              <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-200">
                <div className="flex items-center justify-between">
                  <div><p className="text-green-100 text-sm font-medium">Active Members</p><p className="text-4xl font-bold mt-2">{members.filter(m => m.status === 'Active').length}</p></div>
              ...
              <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-200">
                <div className="flex items-center justify-between">
                  <div><p className="text-orange-100 text-sm font-medium">Total Tithes</p><p className="text-4xl font-bold mt-2">GH₵{totalTithes.toFixed(0)}</p></div>
